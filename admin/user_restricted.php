...
if ($_SESSION['type'] == 'Admin') {
    ...
    $query = "SELECT id, username, role, contact_number, email, image FROM users WHERE restricted = 1";
            ...
            <div class="main-body">
                <div class="report-container">
                    ...
                    <a href="user_account.php" class="nav-btn">
                        ...
                        <h1 class="recent-Articles">Restricted Account</h1>
                        ...
                        <table class="table" id="tables">
                            ...
                            <tbody>
                                <?php while ($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        <td><img src="../img/<?php echo htmlspecialchars($row['image']); ?>" class="img-lst" alt="Picture"></td>
                                        ...
                                        <td>
                                            <div class="btn-holdS">
                                                <button class="btn-unrestric" onclick="openUnrestrict(<?php echo $row['id']; ?>)">Unrestrict</button>
                                            </div>
                                        </td>

                                        <div id="unrestrictModal<?php echo $row['id'];?>" class="modal">
                                            <div class="modal-content">
                                                <span class="close-button" data-modal-id="<?php echo $row['id']; ?>">&times;</span>
                                                <p>Unrestrict this user?</p>
                                                <form action="undo_restriction.php" method="POST" style="display: inline-block;">
